...
**Phase 3 — AI Detection + Backend (13 stories):** S-47, S-48, S-49, S-50, S-51, S-52, S-59, S-60, S-61, S-62, S-65, S-66
OAuth middleware (PR #202), rate limiting (PR #205), Claude API service (PR #204), analyze endpoint + template cache (PR #212), document fingerprinting (PR #209), backend proxy client (PR #215), image optimization (PR #199), label dictionary (PR #121), fuzzy matching (PR #121), document viewer (PR #199), field editor bottom sheet (PR #200).
...
### Phase 3 — Critical Path + Backend

| Issue | Story | Description | Unblocked by |
|-------|-------|-------------|-------------|
| #64 | **S-63**: Network-aware AI routing | Route to API or offline heuristics based on connectivity | S-59, S-62 |
...
**S-63 is the current blocker.** It's now unblocked and ready to build.

## Recommended Priority

1. **S-63** — network-aware AI routing, next on critical path (unblocked!)
