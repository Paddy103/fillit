...
S-01 through S-07 (foundation + server deployment + mobile build), S-08 (profile types), S-09 (document types), S-10 (SA ID validation), S-11 (field normalization), S-12 (provinces), S-13 (encryption), S-14 (secure key management), S-46 (server middleware) are all merged.
...
All 4 groups (A-D) are fully independent — **up to 11 stories** can be built in parallel. For practical parallelism, prioritize Groups A + B + C (7 stories) as they unblock the most downstream work.
