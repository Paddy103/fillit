...
export const LABEL_DICTIONARY: Record<string, DictionaryEntry> = {
  ...
  'bank name': { fieldPath: 'documents[bank_account].additionalFields.bankName', category: 'banking' },
  'banknaam': { fieldPath: 'documents[bank_account].additionalFields.bankName', category: 'banking' },
  'bank naam': { fieldPath: 'documents[bank_account].additionalFields.bankName', category: 'banking' },
  ...
  'branch code': { fieldPath: 'documents[bank_account].additionalFields.branchCode', category: 'banking' },
  'branch': { fieldPath: 'documents[bank_account].additionalFields.branchCode', category: 'banking' },
  'branch number': { fieldPath: 'documents[bank_account].additionalFields.branchCode', category: 'banking' },
  'takkode': { fieldPath: 'documents[bank_account].additionalFields.branchCode', category: 'banking' },
  'tak kode': { fieldPath: 'documents[bank_account].additionalFields.branchCode', category: 'banking' },
  'account type': { fieldPath: 'documents[bank_account].additionalFields.accountType', category: 'banking' },
  'rekeningtipe': { fieldPath: 'documents[bank_account].additionalFields.accountType', category: 'banking' },
  'rekening tipe': { fieldPath: 'documents[bank_account].additionalFields.accountType', category: 'banking' },
  'account holder': { fieldPath: 'documents[bank_account].additionalFields.accountHolder', category: 'banking' },
  'rekeninghouer': { fieldPath: 'documents[bank_account].additionalFields.accountHolder', category: 'banking' },
  ...
  'medical aid plan': { fieldPath: 'documents[medical_aid].additionalFields.plan', category: 'medical' },
  ...
  'main member': { fieldPath: 'documents[medical_aid].additionalFields.mainMember', category: 'medical' },
  'principal member': { fieldPath: 'documents[medical_aid].additionalFields.mainMember', category: 'medical' },
  'hooflid': { fieldPath: 'documents[medical_aid].additionalFields.mainMember', category: 'medical' },

  'dependant': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'dependant number': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'dependent': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'dependent number': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'dependant no': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'afhanklike': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  'afhanklike nommer': { fieldPath: 'documents[medical_aid].additionalFields.dependantNumber', category: 'medical' },
  ...
  'emergency contact number': { fieldPath: 'emergencyContacts[0].phoneMobile', category: 'emergency' },
  ...
  'emergency relationship': { fieldPath: 'emergencyContacts[0].relationship', category: 'emergency' },
  ...
  'next of kin relationship': { fieldPath: 'emergencyContacts[0].relationship', category: 'emergency' },
  ...
  'vehicle registration': { fieldPath: 'documents[vehicle_registration].number', category: 'identity' },
  'registration number': { fieldPath: 'documents[vehicle_registration].number', category: 'identity' },
  ...
  'voertuigregistrasie': { fieldPath: 'documents[vehicle_registration].number', category: 'identity' },
  ...
  'professionele liggaam': { fieldPath: 'professionalRegistrations[0].body', category: 'professional' },

  'professional registration number': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'registration no': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'practice number': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'practice no': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'hpcsa number': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'hpcsa no': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'praktyknommer': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },
  'praktyk nommer': { fieldPath: 'professionalRegistrations[0].registrationNumber', category: 'professional' },

  // ─── Birth Certificate ───────────────────────────────────────────
  'birth certificate': { fieldPath: 'documents[birth_certificate].number', category: 'identity' },
  'birth certificate number': { fieldPath: 'documents[birth_certificate].number', category: 'identity' },
  'geboortesertifikaat': { fieldPath: 'documents[birth_certificate].number', category: 'identity' },

  // ─── Marriage Certificate ────────────────────────────────────────
  'marriage certificate': { fieldPath: 'documents[marriage_certificate].number', category: 'identity' },
  'marriage certificate number': { fieldPath: 'documents[marriage_certificate].number', category: 'identity' },
  ...
  'asylum seeker permit': { fieldPath: 'documents[asylum_seeker_permit].number', category: 'identity' },
};
