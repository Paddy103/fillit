 ...
 */
export function isValidSAProvince(province: string): province is SAProvince {
 ...
 */
export function isValidSAProvinceAbbreviation(abbr: string): abbr is SAProvinceAbbreviation {
 ...
 */
export function getProvinceFromAbbreviation(abbr: string): SAProvince | undefined {
 ...
 */
export function getAbbreviationFromProvince(province: string): SAProvinceAbbreviation | undefined {
 ...
 * the known ranges.
 */
export function suggestProvinceFromPostalCode(postalCode: string): SAProvince | undefined {
